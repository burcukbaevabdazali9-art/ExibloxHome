/* =====================================================
   ...
   Подключить в index.html:  <script src="phone.js"></script>
   ПОСЛЕ всех остальных скриптов (app.js, windows.js…)
   ===================================================== */
...
(function () {
  ...
  #device-select-overlay{
    ...
    background:radial-gradient(ellipse at 30% 40%, #061428 0%, #020810 100%);
  ...
  .ds-card{
    ...
    cursor:pointer;padding:32px 28px;border-radius:24px;
  ...
  .ds-card::before{
    ...
    background:radial-gradient(circle at 50% 0%,rgba(0,120,212,.18) 0%,transparent 70%);
  ...
  .ds-card:hover{
    ...
    box-shadow:0 24px 60px rgba(0,100,200,.25);
  }
  .ds-card:hover::before{opacity:1;}
  .ds-card-icon{font-size:64px;filter:drop-shadow(0 8px 24px rgba(0,0,0,.6));}
  .ds-card-name{
    font-family:'Segoe UI',system-ui,sans-serif;
    font-size:14px;font-weight:500;color:rgba(255,255,255,.85);letter-spacing:.5px;
  }
  .ds-card-desc{
  ...
  .ds-badge{
    ...
    background:var(--accent,#0078d4);color:#fff;font-size:9px;
    padding:2px 7px;border-radius:10px;letter-spacing:.5px;font-weight:600;
  }
  ...
  .phone-device{
    ...
    background:#0a0a0f;border-radius:54px;
    box-shadow:
      0 0 0 2px #1a1a2e,
      0 0 0 4px #252540,
  ...
  .phone-island{
    ...
    width:120px;height:36px;background:#000;border-radius:20px;z-index:100;
    display:flex;align-items:center;justify-content:center;gap:6px;
    transition:all .3s cubic-bezier(.34,1.2,.64,1);cursor:pointer;
  }
  ...
  /* Status bar */
  .phone-statusbar{
    height:54px;padding:14px 28px 0;display:flex;align-items:center;
    justify-content:space-between;z-index:50;flex-shrink:0;
  }
  ...
  .phone-bat{
    width:25px;height:12px;border:1.5px solid rgba(255,255,255,.6);
    border-radius:3px;position:relative;display:flex;align-items:center;padding:1px;
  }
  .phone-bat::after{
    content:'';position:absolute;right:-4px;top:50%;transform:translateY(-50%);
    width:2.5px;height:5px;background:rgba(255,255,255,.6);border-radius:0 1px 1px 0;
  }
  ...
  #phone-lock{
    ...
    background:linear-gradient(170deg,#080e1f 0%,#0d1528 50%,#06090f 100%);
  ...
  .phone-lock-time{
    ...
    margin-top:90px;text-align:center;line-height:1;
    text-shadow:0 0 60px rgba(0,120,212,.3);
  }
  .phone-lock-date{
    font-size:16px;color:rgba(255,255,255,.6);margin-top:8px;
    font-weight:400;letter-spacing:.3px;
  }
  .phone-lock-notifs{
    margin-top:32px;width:340px;display:flex;flex-direction:column;gap:8px;
  }
  .phone-lock-notif{
  ...
  .phone-swipe-line{
    width:134px;height:5px;background:rgba(255,255,255,.3);
    border-radius:3px;
  }
  ...
  #phone-home{
    ...
    background:linear-gradient(160deg,#060d1f 0%,#091422 50%,#060b18 100%);
  ...
  /* Pages indicator */
  .phone-pages-dots{
    display:flex;justify-content:center;gap:5px;margin:6px 0 2px;
  }
  ...
  .phone-app-grid{
    ...
    gap:0;align-content:start;overflow:hidden;
  }
  .phone-app{
  ...
  .phone-app-badge{
    ...
    color:#fff;font-size:9px;min-width:16px;height:16px;
    border-radius:8px;display:flex;align-items:center;justify-content:center;
    padding:0 3px;font-weight:700;border:1.5px solid #0a0a0f;
  }
  /* Dock */
  .phone-dock{
    background:rgba(255,255,255,.1);backdrop-filter:blur(30px);
  ...
  #phone-shade{
    ...
    background:rgba(8,12,20,.92);backdrop-filter:blur(40px);
  ...
  .phone-shade-tile{
    ...
    align-items:center;gap:3px;cursor:pointer;transition:background .15s;
  }
  ...
  .phone-shade-sl input{
    flex:1;accent-color:#0078d4;height:4px;
  ...
  /* ─── APP WINDOWS (fullscreen inside phone) ────── */
  #phone-app-container{
    position:absolute;inset:0;z-index:25;pointer-events:none;
  }
  .phone-app-win{
    position:absolute;inset:0;
    background:linear-gradient(160deg,#06101e 0%,#08121e 100%);
    display:flex;flex-direction:column;
    transform:translateY(100%);
  ...
  .dial-display{
    ...
    padding:16px 20px;text-align:center;width:100%;min-height:64px;
    display:flex;align-items:center;justify-content:center;
  }
  ...
  .dial-call-btn{
    ...
    display:flex;align-items:center;justify-content:center;
    font-size:26px;cursor:pointer;box-shadow:0 8px 24px rgba(46,204,113,.4);
    transition:all .15s;
  }
  ...
  .msg-unread-badge{
    background:#0078d4;color:#fff;font-size:10px;min-width:18px;height:18px;
  ...
  .camera-focus::before,.camera-focus::after{
    content:'';position:absolute;
    width:12px;height:12px;border-color:#f1c40f;border-style:solid;
  }
  ...
  .camera-controls{
    height:120px;background:rgba(0,0,0,.7);
  ...
  .note-item .preview{font-size:12px;color:rgba(255,255,255,.45);
  ...
  .note-editor textarea{
    ...
    border-radius:14px;padding:14px;color:#fff;font-size:14px;
  ...
  .phone-settings-header{font-size:12px;color:rgba(255,255,255,.4);
    padding:6px 12px;letter-spacing:.5px;text-transform:uppercase;}
  .phone-settings-card{
    background:rgba(255,255,255,.07);border-radius:14px;
  ...
  .phone-setting-ico{width:32px;height:32px;border-radius:8px;
    display:flex;align-items:center;justify-content:center;
  ...
  .music-album{
    ...
    background:linear-gradient(135deg,#1a0535,#0d1f5c,#071428);
  ...
  .music-progress-fill{
    height:100%;background:linear-gradient(90deg,#0078d4,#60cdff);
    border-radius:2px;width:35%;transition:width .5s;
  }
  ...
  .music-ctrl{
    font-size:22px;cursor:pointer;color:rgba(255,255,255,.7);
    transition:all .15s;
  }
  ...
  .phone-browser-input{
    ...
    border-radius:20px;padding:8px 14px;color:#fff;font-size:12px;
    outline:none;font-family:inherit;user-select:text;
  }
  .phone-browser-go{
    width:34px;height:34px;border-radius:10px;background:rgba(0,120,212,.6);
    display:flex;align-items:center;justify-content:center;
    font-size:14px;cursor:pointer;transition:background .15s;
  }
  ...
  .phone-exit-btn{
    ...
    background:rgba(255,255,255,.1);
    display:flex;align-items:center;justify-content:center;
    font-size:14px;cursor:pointer;color:rgba(255,255,255,.6);
  ...
  <div id="phone-shell">
    <div class="phone-device" id="phone-device">
      ...
      <div class="phone-island" id="phone-island">
      ...
      <div id="phone-lock">
        ...
        <div class="phone-statusbar" style="position:relative;z-index:5;width:100%;">
          ...
          <div class="phone-status-icons">
            <span class="phone-sig">●●●</span>
            <span style="font-size:11px;color:#fff;margin-left:2px;">5G</span>
            <div class="phone-bat"><div class="phone-bat-fill"></div></div>
          </div>
        </div>
        ...
        <div class="phone-lock-notifs">
          <div class="phone-lock-notif">
            <div class="ico">🤖</div>
            <div class="txt"><div class="app">Exian.AI</div><div class="msg">Готов помочь вам сегодня!</div></div>
          </div>
          <div class="phone-lock-notif">
            <div class="ico">📱</div>
            <div class="txt"><div class="app">ExiWin Mobile</div><div class="msg">Добро пожаловать в ExiWin 12</div></div>
          </div>
        </div>
        <div class="phone-swipe-hint">
          <div class="phone-swipe-line"></div>
          <div class="phone-swipe-text">Проведите вверх для разблокировки</div>
        </div>
      </div>
      ...
      <div id="phone-home">
        ...
        <div class="phone-statusbar" style="position:relative;z-index:10;">
          ...
          <div class="phone-status-icons">
            <span class="phone-sig">●●●</span>
            <span style="font-size:11px;color:#fff;margin-left:2px;">5G</span>
            <div class="phone-bat"><div class="phone-bat-fill" style="width:75%"></div></div>
          </div>
        </div>
        ...
        <div class="phone-home-content">
          <div class="phone-widget-row">
            <div class="phone-clock-widget">
              <div>
                <div class="time" id="widget-time">12:00</div>
                <div class="date" id="widget-date">Вт, 17 февраля</div>
              </div>
              <div class="weather">
                <div class="temp">-3°</div>
                <div class="cond">☁️ Облачно</div>
              </div>
            </div>
          </div>
          <div class="phone-pages-dots">
        ...
        <div class="phone-home-indicator">
          <div class="phone-home-bar" onclick="PhoneModule.goHome()"></div>
        </div>
      </div>
      ...
      <div id="phone-shade">
        ...
        <div class="phone-notif-list">
          <div class="phone-shade-notif">
            <span style="font-size:20px;">🤖</span>
            <div><div style="font-size:11px;color:rgba(255,255,255,.5)">Exian.AI · сейчас</div><div style="font-size:13px;color:#fff;margin-top:2px;">Привет! Чем могу помочь?</div></div>
          </div>
          <div class="phone-shade-notif">
            <span style="font-size:20px;">💬</span>
            <div><div style="font-size:11px;color:rgba(255,255,255,.5)">Сообщения · 2 мин</div><div style="font-size:13px;color:#fff;margin-top:2px;">Алекс: Привет! Как дела?</div></div>
          </div>
        </div>
      </div>
      ...
      <div id="phone-app-container">
        ...
        <div class="phone-app-win" id="pwin-dialer">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-dialer">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('dialer')">‹</div>
            <div class="phone-win-title">📞 Телефон</div>
          </div>
          <div class="phone-win-body">
            <div class="dialpad">
              ...
              <div class="dial-grid">
                ...
                <div class="dial-key" onclick="PhoneModule.dialPress('${n}')">
                  <span class="num">${n}</span>${l?`<span class="letters">${l}</span>`:''}
                </div>`).join('')}
              </div>
              <div style="display:flex;align-items:center;justify-content:center;gap:40px;margin-top:4px;">
                ...
                <div class="dial-key" style="background:rgba(200,50,50,.2)" onclick="PhoneModule.dialBackspace()">
                  <span class="num" style="font-size:18px;">⌫</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="phone-app-win" id="pwin-messages">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-messages">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('messages')">‹</div>
            <div class="phone-win-title">💬 Сообщения</div>
            <span style="font-size:18px;cursor:pointer;">✏️</span>
          </div>
          <div class="phone-win-body">
            <div class="msg-list">
              ${[['🧑','Алекс','Привет! Как дела?','2 мин',2],['👩','Мария','Спасибо за помощь!','14:30',0],['🤖','Exian.AI','Готов помочь','сейчас',1],['👨‍💻','Дима','Код работает, спасибо','вчера',0],['🎮','Игровой чат','Играем сегодня?','вчера',3]].map(([av,name,msg,time,unread])=>`
              <div class="msg-thread">
                <div class="msg-avatar" style="background:rgba(0,120,212,.2)">${av}</div>
                <div class="msg-thread-info">
                  ...
                  <div class="msg-thread-preview">${msg}</div>
                </div>
          ...
          <div class="phone-win-body" style="display:flex;flex-direction:column;">
            <div class="camera-view" id="camera-view">
              ...
              <div style="position:absolute;top:16px;left:0;right:0;display:flex;justify-content:space-between;padding:0 16px;z-index:5;">
                <div style="font-size:20px;cursor:pointer;" onclick="PhoneModule.closeApp('camera')">✕</div>
        ...
        <div class="phone-app-win" id="pwin-notes">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-notes">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('notes')">‹</div>
            <div class="phone-win-title">📒 Заметки</div>
            <span style="font-size:20px;cursor:pointer;" onclick="PhoneModule.newNote()">✏️</span>
          </div>
          <div class="phone-win-body" id="notes-body">
        ...
        <div class="phone-app-win" id="pwin-music">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-music">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('music')">‹</div>
            <div class="phone-win-title">🎵 Музыка</div>
          </div>
          <div class="phone-win-body">
            <div class="music-player">
              <div class="music-album" id="music-album-art">🎵</div>
              <div class="music-info">
                <div class="track" id="music-track">Exian Synthwave</div>
                <div class="artist" id="music-artist">ExiWin Sounds</div>
              </div>
              <div class="music-progress" style="width:100%;">
                <div class="music-progress-bar" onclick="PhoneModule.seekMusic(event)">
                  <div class="music-progress-fill" id="music-fill"></div>
                </div>
                <div class="music-times">
                  <span id="music-cur">1:14</span>
                  <span id="music-dur">3:27</span>
                </div>
              </div>
        ...
        <div class="phone-app-win" id="pwin-gallery">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-gallery">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('gallery')">‹</div>
            <div class="phone-win-title">🖼️ Галерея</div>
          </div>
          <div class="phone-win-body">
        ...
        <div class="phone-app-win" id="pwin-phonebrowser">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-phonebrowser">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('phonebrowser')">‹</div>
            <div class="phone-win-title">🌐 Edge</div>
          </div>
          <div class="phone-win-body" style="overflow:hidden;">
            <div class="phone-browser-bar">
              <input class="phone-browser-input" id="phone-br-url" placeholder="Поиск или адрес..." onkeydown="if(event.key==='Enter')PhoneModule.phoneBrGo()">
              <div class="phone-browser-go" onclick="PhoneModule.phoneBrGo()">→</div>
            </div>
        ...
        <div class="phone-app-win" id="pwin-phonesettings">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-phonesettings">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('phonesettings')">‹</div>
            <div class="phone-win-title">⚙️ Настройки</div>
          </div>
          <div class="phone-win-body">
            <div class="phone-settings-list">
              <div style="text-align:center;padding:16px 0 20px;">
                <div id="phone-settings-avatar" style="font-size:60px;margin-bottom:8px;">🧑</div>
                <div id="phone-settings-name" style="font-size:16px;font-weight:500;color:#fff;">Пользователь</div>
                <div style="font-size:12px;color:rgba(255,255,255,.4);margin-top:2px;">Аккаунт ExiWin</div>
              </div>
              <div class="phone-settings-section">
                <div class="phone-settings-header">Подключения</div>
                <div class="phone-settings-card">
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(0,120,212,.2);">📶</div>
                    <div class="phone-setting-text"><div class="n">Wi-Fi</div><div class="d">ExiWin-Network</div></div>
                    <div class="phone-toggle on" onclick="this.classList.toggle('on')"></div>
                  </div>
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(0,150,255,.2);">🔵</div>
                    <div class="phone-setting-text"><div class="n">Bluetooth</div><div class="d">Включён</div></div>
                    <div class="phone-toggle on" onclick="this.classList.toggle('on')"></div>
                  </div>
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(200,100,0,.2);">✈️</div>
                    <div class="phone-setting-text"><div class="n">Авиарежим</div></div>
                    <div class="phone-toggle" onclick="this.classList.toggle('on')"></div>
                  </div>
                </div>
              </div>
              <div class="phone-settings-section">
                <div class="phone-settings-header">Экран и звук</div>
                <div class="phone-settings-card">
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(255,200,0,.2);">🔆</div>
                    <div class="phone-setting-text"><div class="n">Яркость</div><div class="d">Авто</div></div>
                    <div class="phone-toggle on" onclick="this.classList.toggle('on')"></div>
                  </div>
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(100,50,200,.2);">🌙</div>
                    <div class="phone-setting-text"><div class="n">Ночной режим</div></div>
                    <div class="phone-toggle" onclick="this.classList.toggle('on')"></div>
                  </div>
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(0,200,100,.2);">🔊</div>
                    <div class="phone-setting-text"><div class="n">Не беспокоить</div></div>
                    <div class="phone-toggle" onclick="this.classList.toggle('on')"></div>
                  </div>
                </div>
              </div>
              <div class="phone-settings-section">
                <div class="phone-settings-header">О телефоне</div>
                <div class="phone-settings-card">
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(0,120,212,.2);">📱</div>
                    <div class="phone-setting-text"><div class="n">ExiPhone 12 Pro</div><div class="d">ExiWin Mobile 12.0</div></div>
                  </div>
                  <div class="phone-setting-row">
                    <div class="phone-setting-ico" style="background:rgba(100,200,0,.2);">🔋</div>
                    <div class="phone-setting-text"><div class="n">Батарея</div><div class="d">75% · ~8 часов</div></div>
                  </div>
                </div>
              </div>
              <div class="phone-settings-section">
                <div class="phone-settings-card">
                  <div class="phone-setting-row" style="justify-content:center;" onclick="PhoneModule.exitPhone()">
                    <div style="font-size:13px;color:#e74c3c;font-weight:500;">⎋ Сменить устройство</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="phone-app-win" id="pwin-phonechat">
          <div class="phone-statusbar" style="background:rgba(0,0,0,.3);flex-shrink:0;">
            <span class="phone-time" id="pwin-time-phonechat">12:00</span>
            <div class="phone-status-icons"><div class="phone-bat"><div class="phone-bat-fill"></div></div></div>
          </div>
          <div class="phone-win-header">
            <div class="phone-win-back" onclick="PhoneModule.closeApp('phonechat')">‹</div>
            <div class="phone-win-title">🤖 Exian.AI</div>
            <div style="width:10px;height:10px;border-radius:50%;background:#2ecc71;margin-left:auto;"></div>
          </div>
          <div class="phone-win-body" style="overflow:hidden;display:flex;flex-direction:column;">
            ...
            <div style="padding:10px 12px;border-top:1px solid rgba(255,255,255,.06);display:flex;gap:8px;background:rgba(0,0,0,.2);">
              <textarea id="phone-chat-input" placeholder="Сообщение..." rows="1"
                style="flex:1;background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:10px 14px;color:#fff;font-size:13px;font-family:inherit;resize:none;outline:none;user-select:text;max-height:80px;"
                onkeydown="if(event.key==='Enter'&&!event.shiftKey){event.preventDefault();PhoneModule.phoneChatSend();}"></textarea>
              <div onclick="PhoneModule.phoneChatSend()"
                style="width:40px;height:40px;border-radius:50%;background:linear-gradient(135deg,#0078d4,#60cdff);display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:16px;flex-shrink:0;align-self:flex-end;">➤</div>
            </div>
          </div>
        </div>

      </div><!-- /phone-app-container -->
    </div><!-- /phone-device -->
  </div><!-- /phone-shell -->
  `;
  ...
  const PhoneModule = window.PhoneModule = {
    ...
    initPhone() {
      ...
      this.renderGallery();
      this.setupLockSwipe();
      this.setupShadeSwipe();
      this.updatePhoneTime();
      setInterval(() => this.updatePhoneTime(), 1000);
      // Init chat welcome
      if (this.phoneChatHistory.length === 0) {
        this.addPhoneMessage('bot', 'Привет! Я Exian.AI 3.0. Чем могу помочь тебе сегодня? 🤖');
      }
    ...
    _getUser() {
      try {
        const u = localStorage.getItem('exiwin_user');
    ...
    updatePhoneTime() {
      ...
      const d = now.toLocaleDateString('ru-RU', { weekday: 'short', day: 'numeric', month: 'long' });
      ['phone-lock-time','phone-home-time','phone-shade-time','widget-time'].forEach(id => {
        const el = document.getElementById(id);
        if (el) el.textContent = t;
      });
      document.querySelectorAll('[id^="pwin-time-"]').forEach(el => el.textContent = t);
      const lb = document.getElementById('phone-lock-bigtime');
      if (lb) lb.textContent = t;
      const ld = document.getElementById('phone-lock-date');
      if (ld) ld.textContent = now.toLocaleDateString('ru-RU', { weekday: 'long', day: 'numeric', month: 'long' });
      const wd = document.getElementById('widget-date');
      if (wd) wd.textContent = now.toLocaleDateString('ru-RU', { weekday: 'short', day: 'numeric', month: 'long' });
    },
    ...
    renderAppGrid() {
      ...
      if (!grid) return;
      grid.innerHTML = this.phoneApps.map(app => `
        <div class="phone-app" onclick="PhoneModule.openApp('${app.id}')">
          <div class="phone-app-ico" style="background:${app.bg};">
            ${app.emoji}
            ${app.badge ? `<div class="phone-app-badge">${app.badge}</div>` : ''}
          </div>
    ...
    renderDock() {
      ...
      if (!dock) return;
      dock.innerHTML = this.dockApps.map(app => `
        <div class="phone-app" onclick="PhoneModule.openApp('${app.id}')" style="padding:8px;">
          <div class="phone-app-ico" style="background:${app.bg};width:54px;height:54px;">
            ${app.emoji}
          </div>
        </div>`).join('');
    },
    ...
    setupLockSwipe() {
      ...
      lock.addEventListener('touchmove', e => {
        ...
        if (dy > 0) lock.style.transform = `translateY(-${Math.min(dy * 0.5, 100)}px)`;
      }, { passive: true });
      lock.addEventListener('touchend', e => {
        const dy = startY - e.changedTouches[0].clientY;
        if (dy > 60) this.unlock();
        else lock.style.transform = '';
      });
      // Mouse support
      lock.addEventListener('mousedown', e => { startY = e.clientY; lock._dragging = true; });
      document.addEventListener('mousemove', e => {
        if (!lock._dragging) return;
        const dy = startY - e.clientY;
        if (dy > 0) lock.style.transform = `translateY(-${Math.min(dy * 0.5, 100)}px)`;
      });
      document.addEventListener('mouseup', e => {
        if (!lock._dragging) return;
        lock._dragging = false;
        const dy = startY - e.clientY;
        if (dy > 60) this.unlock();
        else lock.style.transform = '';
      });
    ...
    /* ── Shade swipe ── */
    setupShadeSwipe() {
      const drag = document.getElementById('phone-shade-drag');
      const shade = document.getElementById('phone-shade');
      if (!drag || !shade) return;
      let startY = 0;
      drag.addEventListener('mousedown', e => { startY = e.clientY; drag._down = true; });
      document.addEventListener('mousemove', e => {
        if (!drag._down) return;
        if (e.clientY - startY > 30) { shade.classList.add('open'); drag._down = false; }
      });
      document.addEventListener('mouseup', () => { drag._down = false; });
      // Close shade on phone-home click
      document.getElementById('phone-home')?.addEventListener('click', e => {
        if (!e.target.closest('#phone-shade') && !e.target.closest('#phone-shade-drag')) {
    ...
    openApp(id) {
      ...
      const win = document.getElementById('pwin-' + id);
      if (!win) return;
      ...
      this.currentApp = id;
      // Remove badge
      const app = this.phoneApps.find(a => a.id === id);
      if (app) { app.badge = 0; this.renderAppGrid(); }
    },
    closeApp(id) {
      const win = document.getElementById('pwin-' + id);
      if (win) win.classList.remove('open');
      this.currentApp = null;
      const anyOpen = document.querySelectorAll('.phone-app-win.open').length > 0;
      if (!anyOpen) document.getElementById('phone-app-container').style.pointerEvents = 'none';
    },
    goHome() {
      document.querySelectorAll('.phone-app-win').forEach(w => w.classList.remove('open'));
    ...
    dialPress(key) {
      this.dialNumber += key;
      const el = document.getElementById('dial-num');
      if (el) el.textContent = this.dialNumber;
    },
    dialBackspace() {
    ...
    dialCall() {
      ...
      this._showPhoneNotif('📞', 'Вызов', `Звоним на ${this.dialNumber}...`);
    },
    ...
    renderNotes() {
      ...
      list.innerHTML = this.notes.map(n => `
        <div class="note-item" onclick="PhoneModule.openNote(${n.id})">
          <div class="title">${n.title}</div>
          <div class="preview">${n.body.substring(0, 60)}</div>
    ...
    openNote(id) {
      ...
      body.innerHTML = `
        <div class="note-editor">
          <input type="text" value="${note.title}" id="note-edit-title"
            style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:10px;padding:10px 14px;color:#fff;font-size:16px;font-weight:500;outline:none;font-family:inherit;user-select:text;">
          <textarea id="note-edit-body">${note.body}</textarea>
          <div style="display:flex;gap:8px;">
            <div onclick="PhoneModule.saveNote(${id})"
              style="flex:1;background:rgba(0,120,212,.4);border-radius:12px;padding:12px;text-align:center;cursor:pointer;font-size:13px;color:#fff;">💾 Сохранить</div>
            <div onclick="PhoneModule.deleteNote(${id})"
              style="background:rgba(200,50,50,.3);border-radius:12px;padding:12px 16px;text-align:center;cursor:pointer;font-size:13px;color:#e74c3c;">🗑️</div>
            <div onclick="PhoneModule.backToNotesList()"
              style="background:rgba(255,255,255,.08);border-radius:12px;padding:12px 16px;text-align:center;cursor:pointer;font-size:13px;color:rgba(255,255,255,.7);">‹ Назад</div>
          </div>
        </div>`;
    },
    saveNote(id) {
      const note = this.notes.find(n => n.id === id);
      if (!note) return;
      note.title = document.getElementById('note-edit-title')?.value || note.title;
      note.body = document.getElementById('note-edit-body')?.value || note.body;
      note.date = 'Сейчас';
      this.backToNotesList();
      this._showPhoneNotif('📒','Заметки','Сохранено!');
    },
    deleteNote(id) {
    ...
    newNote() {
      const id = Date.now();
      this.notes.unshift({ id, title: 'Новая заметка', body: '', date: 'Сейчас' });
      this.openNote(id);
    },
    backToNotesList() {
      const body = document.getElementById('notes-body');
      body.innerHTML = '<div class="notes-list" id="notes-list"></div>';
      this.renderNotes();
    },
    ...
    renderGallery() {
      ...
      grid.innerHTML = emojis.map((em, i) => `
        <div class="gallery-item" style="background:${colors[i%colors.length]};"
             onclick="PhoneModule._showPhoneNotif('🖼️','Галерея','Просмотр фото')">
          <span style="font-size:40px;">${em}</span>
        </div>`).join('');
    },
    ...
    takePhoto() {
      ...
      setTimeout(() => {
        view.style.background = 'linear-gradient(135deg,#0a0a14 0%,#141428 100%)';
        const thumb = document.getElementById('cam-last');
        if (thumb) thumb.textContent = ['🌅','🎆','🌙','🌈','🎨'][Math.floor(Math.random()*5)];
        this._showPhoneNotif('📷','Камера','Фото сохранено в галерею');
      }, 120);
    },
    flipCamera() {
      const view = document.getElementById('camera-view');
      view.style.animation = 'phoneShake .3s ease';
      setTimeout(() => { view.style.animation = ''; }, 300);
      this._showPhoneNotif('📷','Камера','Фронтальная камера');
    },
    ...
    toggleMusic() {
      ...
      if (btn) btn.textContent = this.musicPlaying ? '⏸' : '▶';
      if (this.musicPlaying) {
        this.musicTimer = setInterval(() => {
          this.musicProgress = Math.min(100, this.musicProgress + 0.3);
          const fill = document.getElementById('music-fill');
          if (fill) fill.style.width = this.musicProgress + '%';
          // Update current time display (fake)
          const cur = document.getElementById('music-cur');
          if (cur) {
            const totalSecs = 207;
            const s = Math.floor(totalSecs * this.musicProgress / 100);
    ...
    prevTrack() {
      ...
      this.musicPlaying = false;
      this.musicProgress = 0;
      this.musicIdx = (this.musicIdx - 1 + this.musicTracks.length) % this.musicTracks.length;
      this._updateMusicUI();
    },
    _updateMusicUI() {
      ...
      const cur = document.getElementById('music-cur');
      const btn = document.getElementById('music-play-btn');
      if (track) track.textContent = t.title;
    ...
    seekMusic(e) {
      ...
      this.musicProgress = ((e.clientX - rect.left) / rect.width) * 100;
      const fill = document.getElementById('music-fill');
      if (fill) fill.style.width = this.musicProgress + '%';
    },
    ...
    /* ── BROWSER ── */
    phoneBrGo() {
      const input = document.getElementById('phone-br-url');
      const frame = document.getElementById('phone-br-frame');
    ...
    phoneChatSend() {
      ...
      setTimeout(() => {
        this.addPhoneMessage('bot', null, true); // typing
        const typingId = Date.now();
        setTimeout(() => {
          const responses = [
            'Отличный вопрос! Я Exian.AI 3.0 — умный ассистент ExiWin. Чем ещё могу помочь?',
            'Понял вас! Это интересная тема. Давайте разберёмся вместе.',
            'ExiWin 12 — лучшая система для работы и творчества! 🚀',
            'Я могу помочь с кодом, идеями, информацией и многим другим.',
            `Ваш запрос: "${text.substring(0,30)}..." — обрабатываю...`,
          ];
          const resp = responses[Math.floor(Math.random() * responses.length)];
          // Remove typing bubble
          const typing = document.getElementById('phone-typing-' + typingId);
          if (typing) typing.remove();
          this.addPhoneMessage('bot', resp);
        }, 1200);
      }, 100);
    },
    addPhoneMessage(role, text, isTyping) {
      ...
      if (isTyping) {
        ...
        div.innerHTML = `
          <div style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#0078d4,#60cdff);display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0;">🤖</div>
          <div style="background:rgba(255,255,255,.08);border-radius:14px 14px 14px 2px;padding:12px 16px;">
            <span class="edot"></span><span class="edot"></span><span class="edot"></span>
          </div>`;
      } else {
        const bubbleStyle = isBot
          ? 'background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.1);border-radius:4px 14px 14px 14px;max-width:80%;'
          : 'background:linear-gradient(135deg,#0078d4,#006cbf);border-radius:14px 14px 4px 14px;max-width:80%;';
        div.innerHTML = `
          ${isBot ? `<div style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#0078d4,#60cdff);display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0;">🤖</div>` : ''}
          <div style="${bubbleStyle}padding:10px 14px;font-size:13px;line-height:1.5;color:#fff;">${text}</div>
          ${!isBot ? `<div style="width:28px;height:28px;border-radius:50%;background:rgba(255,255,255,.1);display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0;">${this._getUser()?.avatar||'🧑'}</div>` : ''}`;
      }
    ...
    _showPhoneNotif(ico, title, text) {
      ...
      n.style.cssText = `
        ...
        background:rgba(20,26,44,.96);backdrop-filter:blur(20px);
        border:1px solid rgba(255,255,255,.12);border-radius:16px;
        padding:12px 14px;display:flex;gap:10px;align-items:center;
        animation:notifSlide .3s ease;box-shadow:0 8px 30px rgba(0,0,0,.5);
      `;
  ...
  /* ─── INTERCEPT LOGIN/REGISTER FLOW ─────────────── */
  // After login/register, show device select instead of going straight to desktop
  function patchPostLogin() {
    // Try to hook into existing flow
    // We patch the lock/desktop visibility to show device select first

    // Override doLogin / doRegister endings
    const origDoLogin = window.doLogin;
    const origDoRegister = window.doRegister;

    function postLoginHook() {
      // Hide desktop & taskbar, show device select
      setTimeout(() => {
        const desktop = document.getElementById('desktop');
        const taskbar = document.getElementById('taskbar');
        const reg = document.getElementById('regscreen');
    ...
    if (typeof origDoLogin === 'function') {
      window.doLogin = function() {
        origDoLogin.apply(this, arguments);
        // Check if login succeeded by watching for desktop visibility
        const obs = new MutationObserver((mutations) => {
          for (const m of mutations) {
            const desktop = document.getElementById('desktop');
            if (desktop && desktop.style.display !== 'none' && desktop.style.display !== '') {
              obs.disconnect();
              postLoginHook();
              return;
            }
        ...
        const desktop = document.getElementById('desktop');
        if (desktop) obs.observe(desktop, { attributes: true, attributeFilter: ['style'] });
        // Fallback timeout
        setTimeout(() => {
          const desktop = document.getElementById('desktop');
          if (desktop && (desktop.style.display === '' || desktop.style.display === 'flex' || desktop.style.display === 'block')) {
            obs.disconnect();
            postLoginHook();
          }
        }, 800);
    ...
    if (typeof origDoRegister === 'function') {
      window.doRegister = function() {
        origDoRegister.apply(this, arguments);
        setTimeout(() => {
          const desktop = document.getElementById('desktop');
          if (desktop && (desktop.style.display === '' || desktop.style.display === 'flex' || desktop.style.display === 'block')) {
            postLoginHook();
    ...
    // Also patch showDesktop / direct desktop show if boot goes straight there
    const origShowDesktop = window.showDesktop;
    if (typeof origShowDesktop === 'function') {
      window.showDesktop = function() {
        origShowDesktop.apply(this, arguments);
        postLoginHook();
      };
    }
  }
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', patchPostLogin);
  } else {
    // Scripts may not all be loaded yet, wait a tick
    setTimeout(patchPostLogin, 100);
  }

  // Also observe body for any direct desktop show in case boot is synchronous
  const bodyObs = new MutationObserver(() => {
    const desktop = document.getElementById('desktop');
    const overlay = document.getElementById('device-select-overlay');
    const phone = document.getElementById('phone-shell');
    // If desktop became visible AND device select not shown AND phone not shown
    if (desktop && (desktop.style.display === '' || desktop.style.display === 'block' || desktop.style.display === 'flex')) {
      if (overlay && overlay.style.display !== 'flex' && phone && phone.style.display !== 'flex') {
        bodyObs.disconnect();
        setTimeout(() => {
  ...
  // Also watch desktop display changes
  setTimeout(() => {
    const desktop = document.getElementById('desktop');
    if (desktop) {
      const desktopObs = new MutationObserver(() => {
        const overlay = document.getElementById('device-select-overlay');
        const phone = document.getElementById('phone-shell');
        if ((desktop.style.display === '' || desktop.style.display === 'block' || desktop.style.display === 'flex') &&
      ...
      desktopObs.observe(desktop, { attributes: true, attributeFilter: ['style'] });
    }
  }, 200);
